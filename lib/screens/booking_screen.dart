...
class _BookingScreenState extends State<BookingScreen>
  ...
  final List<Map<String, dynamic>> _emergencyTypes = [
    {'label': 'Cardiac', 'icon': Icons.favorite_border_rounded, 'color': AppTheme.crimson},
    {'label': 'Accident', 'icon': Icons.car_crash_rounded, 'color': const Color(0xFFE65100)},
    {'label': 'Breathing', 'icon': Icons.air_rounded, 'color': AppTheme.blue},
    {'label': 'Other', 'icon': Icons.more_horiz_rounded, 'color': const Color(0xFF6B48FF)},
  ];
  ...
  Future<void> _submitRequest() async {
    ...
    _submitAnim.animateTo(0.96).then((_) => _submitAnim.animateTo(1.0));
            ...
            Container(
              ...
              decoration: BoxDecoration(
                gradient: const LinearGradient(
                    colors: [Color(0xFF00E676), Color(0xFF00C851)],
      ...
      leading: GestureDetector(
        ...
        child: Container(
          ...
          child: const Icon(Icons.arrow_back_ios_new_rounded,
              color: AppTheme.textDark, size: 17),
        ),
      ),
          ...
          child: GestureDetector(
            ...
            child: AnimatedContainer(
              ...
              child: Column(
                children: [
                  Icon(
                      _conditionLevels[i]['icon'],
                      color: selected ? color : AppTheme.textLight,
                      size: 22),
                  const SizedBox(height: 6),
                  Text(
                    _conditionLevels[i]['label'],
                    style: GoogleFonts.outfit(
                        fontSize: 12,
                        fontWeight: selected ? FontWeight.w700 : FontWeight.w500,
      ...
      child: GestureDetector(
        ...
        child: AnimatedContainer(
          ...
          decoration: BoxDecoration(
            ...
            boxShadow: [
              BoxShadow(
                  color: AppTheme.crimson.withOpacity(0.50),
                  blurRadius: 32,
          ...
          child: Row(
            ...
            children: [
              ...
              Text(
                _isSubmitting ? 'SUBMITTING...' : 'REQUEST AMBULANCE',
                style: GoogleFonts.outfit(
                    fontSize: 16,
                    fontWeight: FontWeight.w800,
                    color: Colors.white,
  ...
  Widget _buildDisclaimerRow() {
    return Row(
      ...
      children: [
        ...
        Flexible(
          child: Text('Dispatcher will call you within 2 minutes to confirm.',
              textAlign: TextAlign.center,
              style: GoogleFonts.outfit(
                  fontSize: 12, color: AppTheme.textLight, height: 1.4)),
        ),
      ],
    );
  }
            ...
            Row(
              children: [
                const Icon(Icons.info_outline_rounded,
                    size: 13, color: AppTheme.crimson),
                const SizedBox(width: 5),
                Text(errorText!,
                    style: GoogleFonts.outfit(
                        fontSize: 11,
